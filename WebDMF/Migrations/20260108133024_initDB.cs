    ...
    public partial class initDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Danh sách định dạng tệp tin cho phép upload", "AllowedExtensions", ".pdf,.docx,.png,.jpg" },
                    { 2, "Hạn mức dung lượng tối đa cho tài khoản Standard (Bytes)", "StandardQuota", "16106127360" },
                    { 3, "Hạn mức dung lượng tối đa cho tài khoản Premium (Bytes)", "PremiumQuota", "107374182400" }
                });
